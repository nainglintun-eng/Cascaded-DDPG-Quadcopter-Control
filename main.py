"""
Main Training Script for Cascaded DDPG Quadcopter Control
...
def print_system_info():
    ...
    print("\n" + "="*80)
    print("CASCADED DDPG QUADCOPTER TRAINING SYSTEM")
    print("="*80)
    print("\nMISSION PROFILE:")
...
def save_agent_as_mat(agent, filepath, agent_key='agent'):
    """
    Save a DDPG agent's actor/critic network weights as a MATLAB .mat file.

    The .mat file contains a struct-like dict with:
        <agent_key>.actor_layers   – list of (W, b) pairs for the actor network
        <agent_key>.critic1_layers – list of (W, b) pairs for the single critic

    To load in MATLAB:
        S = load('z_DDPG_Attitude.mat');
        att = S.att_agent;
...
def main():
    ...
    if TrainingConfig.TRAIN_ATTITUDE_FIRST:
        ...
        save_agent_as_mat(attitude_agent, f'{run_dir}/z_DDPG_Attitude.mat', 'att_agent')
        print(f"\n✓ Attitude agent saved as MATLAB .mat: {run_dir}/z_DDPG_Attitude.mat")
        ...
        attitude_agent.load(r'results\run_20260323_185909\attitude_checkpoint_ep7500.pth')
    ...
    if TrainingConfig.TRAIN_POSITION_SECOND:
        ...
        position_agent.load(r'results\run_20260323_185909\position_phase_2_ep2000.pth')
        ...
        save_agent_as_mat(position_agent, f'{run_dir}/z_DDPG_Position.mat', 'pos_agent')
        print(f"\n✓ Position agent saved as MATLAB .mat: {run_dir}/z_DDPG_Position.mat")
        ...
        position_agent.load('weights/position_controller_final.pth')
